...
public class ScmDiagnosticController {
    ...
    public R<Map<String, Object>> fixComments() {
        ...
        try {
            ...
            List<String> tableCommentSqls = List.of(
            ...
            List<String> supplierColumnSqls = List.of(
                ...
                "ALTER TABLE scm_supplier MODIFY COLUMN `supplier_name` VARCHAR(100) NOT NULL COMMENT '供应商名称'",
                ...
                "ALTER TABLE scm_supplier MODIFY COLUMN `remark` VARCHAR(255) COMMENT '备注'",
            ...
            List<String> qualificationColumnSqls = List.of(
                ...
                "ALTER TABLE scm_supplier_qualification MODIFY COLUMN `audit_remark` VARCHAR(500) COMMENT '审核备注'",
                ...
                "ALTER TABLE scm_supplier_qualification MODIFY COLUMN `remark` VARCHAR(255) COMMENT '备注'",
            ...
            List<String> alertColumnSqls = List.of(
                ...
                "ALTER TABLE scm_qualification_alert MODIFY COLUMN `alert_content` TEXT COMMENT '预警内容'",
            ...
            List<String> classificationLogColumnSqls = List.of(
            ...
            allSqls.addAll(tableCommentSqls);
            allSqls.addAll(supplierColumnSqls);
            allSqls.addAll(qualificationColumnSqls);
            allSqls.addAll(alertColumnSqls);
            allSqls.addAll(classificationLogColumnSqls);
            ...
            result.put("failed_sqls", failedSqls);
            result.put("message", "表及字段注释修复完成，成功" + successCount + "条，失败" + failCount + "条");
            
            log.info("表及字段注释修复完成: 成功{}条，失败{}条", successCount, failCount);
